...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/AROCRYPTO/ARO/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/AROCRYPTO/ARO-DETACHED.SIGS.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/AROCRYPTO/ARO.git

### ARO maintainers/release engineers, suggestion for writing release notes
...
### Build and sign ARO Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit apeiron=v${VERSION} ../apeiron/contrib/gitian-descriptors/gitian-osx.yml
...
Codesigner only: Sign the osx binary:
    ...
    transfer apeiron-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [apeiron-detached-sigs](https://github.com/ARO-Project/apeiron-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/ARO-Project/ARO/releases/new) with a link to the archived release notes.
