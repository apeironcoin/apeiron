...
In order to support loading of multiple wallets in apeiron-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is apeiron.cpp.
...
Changes to apeiron.cpp
----------------------
apeiron.cpp is the entry point into apeiron-qt, and as such, will require some minor modifications to provide hooks for
