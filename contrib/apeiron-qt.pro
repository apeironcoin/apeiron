...
RESOURCES += src/qt/apeiron.qrc src/qt/apeiron_locale.qrc

TRANSLATIONS += src/qt/locale/apeiron_bg.ts \
                src/qt/locale/apeiron_de.ts \
                src/qt/locale/apeiron_en.ts \
                src/qt/locale/apeiron_es.ts \
                src/qt/locale/apeiron_fi.ts \
                src/qt/locale/apeiron_fr.ts \
                src/qt/locale/apeiron_it.ts \
                src/qt/locale/apeiron_ja.ts \
                src/qt/locale/apeiron_pl.ts \
                src/qt/locale/apeiron_pt.ts \
                src/qt/locale/apeiron_ru.ts \
                src/qt/locale/apeiron_sk.ts \
                src/qt/locale/apeiron_sv.ts \
                src/qt/locale/apeiron_vi.ts \
                src/qt/locale/apeiron_zh_CN.ts \
                src/qt/locale/apeiron_zh_TW.ts
