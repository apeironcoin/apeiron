...
// Copyright (c) 2014-2015 The Apeiron and PIVX Core Developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:46123", "127.0.0.1", 46123));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:46123", "127.0.0.1", 46123));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:46123", "::ffff:127.0.0.1", 46123));
    BOOST_CHECK(TestSplitHost("[::]:46123", "::", 46123));
    BOOST_CHECK(TestSplitHost("::46123", "::46123", -1));
    BOOST_CHECK(TestSplitHost(":46123", "", 46123));
    BOOST_CHECK(TestSplitHost("[]:46123", "", 46123));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:46123", "127.0.0.1:46123"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:46123", "[::]:46123"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
