                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("APEIRON-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a APEIR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and apeiron: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About APEIR Core"), this);
    aboutAction->setStatusTip(tr("Show information about APEIR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for APEIR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your APEIR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified APEIR addresses"));
    ...
    openAction->setStatusTip(tr("Open a APEIR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the APEIR Core help message to get a list with possible APEIR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("APEIR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to APEIR network", "", count));
}
...
{
    QString strTitle = tr("APEIR Core"); // default title
