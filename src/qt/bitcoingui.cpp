...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ARO address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ARO Core"), this);
    aboutAction->setStatusTip(tr("Show information about ARO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ARO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ARO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ARO addresses"));
    ...
    openAction->setStatusTip(tr("Open a ARO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ARO Core help message to get a list with possible ARO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ARO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ARO network", "", count));
}
...
{
    QString strTitle = tr("ARO Core"); // default title
