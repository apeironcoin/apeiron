...
/** Utility functions used by the APEIR Qt UI.
 */
namespace GUIUtil
{
...
// Render APEIR addresses in monospace font
...
// Parse "apeiron:" URI into recipient object, return true on successful parsing
