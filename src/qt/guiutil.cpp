...
{
    // Convert apeiron:// to apeiron:
    //
    //    Cannot handle this later, because apeiron:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open apeiron.conf with the associated application */
...
{
    return GetAutostartDir() / "apeiron.desktop";
}
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the apeiron app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add apeiron app to startup item list
