...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("APEIR Core apeiron-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  apeiron-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded apeiron transaction") + "\n" +
                               "  apeiron-tx [options] -create [commands]   " + _("Create hex-encoded apeiron transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded apeiron transaction
