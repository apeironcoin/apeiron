...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"apeiron", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"apeiron", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"apeiron", "mnsync", &mnsync, true, true, false},
        {"apeiron", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use apeirond, or the -server option to apeiron-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> apeiron-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:46124/\n";
}
