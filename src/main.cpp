...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight <= 1 && nHeight > 0) {
		...
		nSubsidy = 1 * COIN;
	} else if (nHeight > 300 && nHeight <= 700) {
		nSubsidy = 5 * COIN; 
	} else if (nHeight > 700 && nHeight <= 2880) {
		nSubsidy = 90 * COIN; 
	} else if (nHeight > 2880 && nHeight <= 10301) {
		nSubsidy = 30 * COIN;
	} else if (nHeight > 10301 && nHeight <= 20302) {
		nSubsidy = 50 * COIN;
	} else if (nHeight > 20302 && nHeight <= 30303) {
		nSubsidy = 80 * COIN;
	} else if (nHeight > 30303 && nHeight <= 40304) {
		nSubsidy = 140 * COIN;
	} else if (nHeight > 40304 && nHeight <= 50305) {
		nSubsidy = 210 * COIN;
	} else if (nHeight > 50305 && nHeight <= 60306) {
		nSubsidy = 300 * COIN;
	} else if (nHeight > 60306 && nHeight <= 70307) {
		nSubsidy = 370 * COIN;
	} else if (nHeight > 70307 && nHeight <= 80308) {
		nSubsidy = 450 * COIN;
	} else if (nHeight > 80308) {
		nSubsidy = 10 * COIN;
